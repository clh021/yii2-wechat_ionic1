...
class CmsCatalog extends \yii\db\ActiveRecord
{
    ...
    public function attributeLabels()
    {
        return [
            ...
            'parent_id' => Module::t('wechat', 'Parent ID'),
            ...
            'is_nav' => Module::t('wechat', 'Is Nav'),
            'sort_order' => Module::t('wechat', 'Sort Order'),
            'page_type' => Module::t('wechat', 'Page Type'),
            'page_size' => Module::t('wechat', 'Page Size'),
            'template_list' => Module::t('wechat', 'Template List'),
            'template_show' => Module::t('wechat', 'Template Show'),
            'template_page' => Module::t('wechat', 'Template Page'),
            'redirect_url' => Module::t('wechat', 'Redirect Url'),
    ...
    {
        $data = [
            self::PAGE_TYPE_LIST => Module::t('wechat', 'PAGE_TYPE_LIST'),
            self::PAGE_TYPE_PAGE => Module::t('wechat', 'PAGE_TYPE_PAGE'),
        ];
    ...
    {
        return [
            self::IS_NAV_YES => Module::t('wechat', 'YES'),
            self::IS_NAV_NO => Module::t('wechat', 'NO'),
        ];
    }
